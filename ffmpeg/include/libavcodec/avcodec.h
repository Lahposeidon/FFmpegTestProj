 ...
 * Scene detect
 */
typedef void *AVSceneContext;

AVSceneContext *avpicture_scene( enum PixelFormat pix_fmt, int width, int height);
void avscene_free( AVSceneContext *scene_ctx);

double avscene_score( AVSceneContext *scene_ctx, AVPicture *pic, double *mafd, double *diff);
